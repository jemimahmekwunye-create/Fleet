...
sns.histplot(df['Monthly_Fuel_Spend_NGN'], bins=15, kde=True, color=core_palette[2], edgecolor='white', linewidth=0.8)
ax.set_title('Distribution of Monthly Fuel Spend (NGN)', pad=15, fontsize=16)
ax.set_xlabel('Monthly Fuel Spend (NGN)')
...
sns.boxplot(x='Digital_Tracking_Usage', y='Fuel_Theft_Incidents', data=df, palette=core_palette)
...
sns.boxplot(
    ...
    showfliers=False,
    medianprops={'color': 'red', 'linewidth': 3} # Forces the median line to be thick and bright red
)
# Stripplot
sns.stripplot(
    x='Digital_Tracking_Usage', 
...
**Link:** [jemimahmekwunye-create/Fleet-repo](https://github.com/jemimahmekwunye-create/Fleet)
