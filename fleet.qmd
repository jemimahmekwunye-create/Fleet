...
fig = px.histogram(
    df, 
    x='Monthly_Fuel_Spend_NGN', 
    nbins=15, 
    title='Distribution of Monthly Fuel Spend (NGN)',
    color_discrete_sequence=['skyblue'],
    marginal='box' # Adds a nice distribution box plot at the top (similar vibe to KDE)
)
# Update layout to add commas to the x-axis numbers automatically
fig.update_layout(
    xaxis_title='Monthly Fuel Spend (NGN)',
    yaxis_title='Frequency',
    xaxis=dict(tickformat=","), # This single line fixes the million-scale numbers!
    bargap=0.05 # Adds a tiny space between bars to look cleaner
)
fig.show()
```
